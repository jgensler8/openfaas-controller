...
import (
	v1 "github.com/jgensler8/openfaas-controller/pkg/apis/cr/v1"
	scheme "github.com/jgensler8/openfaas-controller/pkg/client/clientset/versioned/scheme"
...
// functions implements ExampleInterface
...
func newFunctions(c *CrV1Client, namespace string) *functions {
	return &functions{
		client: c.RESTClient(),
		ns:     namespace,
	}
